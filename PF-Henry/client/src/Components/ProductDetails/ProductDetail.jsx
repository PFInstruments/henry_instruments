                ...
                <div className="col">
                  <ul className="list-inline small float-start">
                    <li className="list-inline-item m-0">
                      <i
                        className={`bi bi-star${rating === 0 ? " text-success fs-5" : "-fill text-success fs-5"
                          }`}
                      ></i>
                    </li>
                    <li className="list-inline-item m-0">
                      <i
                        className={`bi bi-star${rating <= 1 ? " text-success fs-5" : "-fill text-success fs-5"
                          }`}
                      ></i>
                    </li>
                    <li className="list-inline-item m-0">
                      <i
                        className={`bi bi-star${rating <= 2 ? " text-success fs-5" : "-fill text-success fs-5"
                          }`}
                      ></i>
                    </li>
                    <li className="list-inline-item m-0">
                      <i
                        className={`bi bi-star${rating <= 3 ? " text-success fs-5" : "-fill text-success fs-5"
                          }`}
                      ></i>
                    </li>
                    <li className="list-inline-item m-0">
                      <i
                        className={`bi bi-star${rating <= 4 ? " text-success fs-5" : "-fill text-success fs-5"
                          }`}
                      ></i>
                    </li>
                  </ul>
