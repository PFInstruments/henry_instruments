          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              >
                ...
                <div className="mb-3">
                  <label htmlFor="product-model" className="col-form-label">
                    Model:
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="product-brand" className="col-form-label">
                    Brand:
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-3">
                  <label htmlFor="product-stock" className="col-form-label">
                    Stock:
                  </label>
                  <input
                    min={0}
