    ...
    <div className="container bg-grey ">
      <div className="row">
        ...
        <p className="text-justify text-muted">
          Cookies: These are data files that are placed on your device or
        ...
        <p className="text-justify text-muted mt-2">
          ...
          to fulfill orders placed through the Site (including
        ...
        <p className="text-justify text-muted">
          ...
          for (in line with the preferences you have shared with us)
